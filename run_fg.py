...
save_name = "./result/result_" + args.dataset + "_run.csv"
...
# 0.783888
if args.dataset == "cocitation_cora1000":
    args.F = 3
    args.dim_hidden = 512
    args.weight_decay = 0.001
    args.lr = 0.05
